...
TEST_CASE("crossoverPop") {
  ...
  thrust::device_vector<thrust::tuple<bool*, bool*>> pairs(2);
  pairs[0] = thrust::make_tuple<bool*, bool*>(getSpecimen(src1, 0), getSpecimen(src2, 1));
  pairs[1] = thrust::make_tuple<bool*, bool*>(getSpecimen(src1, 1), getSpecimen(src1, 0));
